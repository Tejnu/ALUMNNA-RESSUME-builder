...
import { Mail, Phone, MapPin, Globe, Linkedin, Languages } from 'lucide-react';
      ...
      <div className="p-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          {languages && languages.length > 0 && (
            <section>
              <h2 className="text-xl font-bold text-slate-800 mb-4 uppercase tracking-wide flex items-center gap-2">
                <Languages className="h-5 w-5" />
                <span>Languages</span>
              </h2>
              <div className="space-y-2">
                {languages.map((lang) => (
                  <div key={lang.id} className="flex justify-between items-center border-l-4 border-slate-900 pl-4">
